...
const agents = [
  { name: 'AI Receptionist', desc: 'Answers every call 24/7. Never miss a customer call, day or night.', icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' },
  ...
  { name: 'AI Social Media', desc: 'Creates and posts engaging, on-brand content daily.', icon: 'M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z' },
  ...
  { name: 'AI Reputation Monitor', desc: 'Tracks every mention of your business online.', icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z' },
  ...
  { name: 'AI Proposal Writer', desc: 'Generates professional proposals and quotes instantly.', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { name: 'AI Knowledge Base', desc: 'Builds and maintains a knowledge base for your team.', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
      ...
      <div className="container">
        <div className={styles.header}>
          ...
          <p className={`section-body ${styles.body}`} style={{ margin: '0 auto' }}>
            We don't do generic marketing. Every strategy is custom-built for your specific business.
          </p>
        </div>

        <div className={styles.grid}>
          <div className={styles.card}>
            <h3 className={styles.cardHeading}><span className={styles.blackWord}>Dedicated</span> to Your Growth</h3>
            <p className={styles.cardBody}>
              We live and breathe local business growth. Every strategy we build
              stems from our commitment to helping business owners connect with
          ...
          <div className={styles.card}>
            ...
            <p className={styles.cardBody}>
              ...
              appointments, and revenue growth. You bring the business.
      ...
      <div className={styles.carouselSection}>
        <div className="container">
          <h3 className={styles.carouselHeading}>
            <span className="gradient-text">20 AI Agents</span> Working for Your Business
          </h3>
        </div>
